...
<h2>1. Refresher on the Fetch API</h2>
<h2>2. Difference between Response.json and Response.text</h2>
<h2>3. SvelteKit filesystem-based router</h2>
<h2>4. Create a simple page</h2>
